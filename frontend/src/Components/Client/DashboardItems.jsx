  ...
  return (
    <>
      <div className="lg:flex pt-20 hidden  bg-[#262626]">
        ...
        {!open && (
          <div
            ...
            className="flex justify-center mt-10 xl:hidden"
          >
            <h1 className="h-full text-4xl text-white "> &rarr; </h1>
          </div>
        )}
          ...
          {open && (
            <div className="h-full  w-[289px] fixed pt-10 hidden text-white lg:block  bg-[#131313]">
              <div onClick={() => SetOpen(!open)}>
                <h1 className="pr-4 text-3xl text-end">&larr;</h1>
                <h2 className="pr-3 text-end">close</h2>
              </div>
                ...
                <div>
                  ...
                  <div className="w-[234px] h-[124px] bg-[#202020] flex mt-10 flex-col justify-center items-center rounded-2xl">
                    <h1 className="text-[10px] w-[182px]">
                      Ready to go beyond current plan? Upgrade to give your
                      ideas and designs room to grow without limits.
                    </h1>
        ...
        <div className="h-full  xl:block   w-[289px] fixed pt-10  text-white lg:hidden  bg-[#131313]">
          <div className="  w-[235px] flex flex-col justify-between h-[626px] mx-auto ">
            <div>
              ...
              <div className="w-[234px] h-[124px] bg-[#202020] flex mt-10 flex-col justify-center items-center rounded-2xl">
                <h1 className="text-[10px] w-[182px]">
                  Ready to go beyond current plan? Upgrade to give your ideas
                  and designs room to grow without limits.
                </h1>
                <h1 className="w-[127px] h-[26px] text-[10px] mt-4 bg-[#2898FF] rounded-full flex items-center justify-center">
                  View plans
                </h1>
        ...
        <div className="xl:ml-80 mt-28 bg-[#262626] h-screen">
          <div className="flex gap-4">
            <div>
              <div
                onClick={openPopup}
                className="items-center justify-center xl:flex"
              >
                ...
                <div className="">
                  <h1 className="ml-[-40px] text-white cursor-pointer">+</h1>
                </div>
              </div>
              ...
              {isPopupOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                  <div className="bg-[#232234] text-white  w-[400px] h-[205px] p-6 rounded-lg shadow-md">
                    ...
                    <input
                      type="text"
                      className="w-full mt-6 bg-transparent border-b outline-none "
                    />
                    <br />
          ...
          <div>
            ...
            <div className="flex flex-col w-full h-full gap-4 p-3 text-white border border-gray-700 rounded-2xl">
              <div className="flex items-center justify-between px-4">
                <h1>01</h1>
                <h1>img</h1>
                <h1 className="w-[65px] h-[27px] bg-white text-blue-500 flex justify-center rounded-full items-center">
                  View
                </h1>
                <h1 className="w-[65px] h-[27px] bg-white text-blue-500 flex justify-center rounded-full items-center">
                  Edit
      ...
      <div className="pt-20 md:hidden bg-[#262626] ">
        ...
        <div className="">
          <h1 className="mt-8 mb-3 text-gray-500">Projects</h1>
          <div>
