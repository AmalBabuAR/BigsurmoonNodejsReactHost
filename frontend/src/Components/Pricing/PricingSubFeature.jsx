  ...
  return (
    <>
          ...
          <div className="mt-[25px] lg:mt-[75px] flex justify-center mx-auto gap-[30px] lg:gap-[40px]">
            {pricingSubFeatures.map((data) => (
              <div className="w-[100px] lg:w-[300px]" key={data.id}>
                ...
                <h1 className="mt-[25px] text-[14px] lg:text-[16px] leading-[14px] lg:leading-[24px] font-bold text-center ">
                  {data.title}
                </h1>
                <h1 className="mt-[10px] text-[12px] lg:text-[14px] leading-[18px] lg:leading-[21px] font-normal  text-center ">
                  {data.desc}
                </h1>
              </div>
            ))}
      ...
      <div className="pb-[100px] hidden lg:flex justify-evenly bg-black ">
        <h1 className="text-[30px] mr-[283px] leading-[39px] font-bold tracking-wider text-[#CDCDCD] font-outfit ">
