    ...
    <div className="bg-black">
      <div className="bg-black max-w-[1440px] mx-auto p-4 text-white">
        ...
        <div className="hidden md:block">
          <div className="items-center text-center">
            ...
            <p className="lg:text-lg md:text-[14px] lg:text-[20px] px-20  lg:w-[750px] md:w-[550px]  mx-auto   font-light  mb-10">
              Our well-defined and efficient process ensures that projects are
              executed smoothly, deadlines are met, and the final deliverables
              align with our client's visions.
            </p>
          ...
          <div className="items-center justify-center md:grid md:grid-cols-2 md:px-10 mt-28 lg:px-28 ">
            <div className="flex flex-col justify-center mx-auto ">
              ...
              <p className="mb-7 font-light xl:text-[26px] text-[14px] lg:text-lg w-3/4 ">
          ...
          <div className="items-center justify-between px-10 md:grid md:grid-cols-2 mt-28 lg:px-20 ">
            <div className="flex flex-col justify-center mx-auto ">
              ...
              <p className="mb-4 font-light  xl:text-[26px] text-[14px]  lg:text-lg  w-3/4  ">
          ...
          <div className="md:grid md:grid-cols-2 mt-28 lg:px-10 ">
            ...
            <div className="flex flex-col justify-around ">
              ...
              <p className="mb-4 font-light xl:mt-[-50px]  xl:text-[26px] text-[14px] lg:text-lg w-3/4 ">
      ...
      <div className="bg-black">
        <div className="bg-black max-w-[1440px] mx-auto text-white px-3 pt-10 md:pt-10 md:pb-20 md:flex md:items-center md:justify-between md:px-10 lg:px-16 lg:pb-8 ">
          <div>
            <h5 className="text-[25px] font-semibold lg:text-[36px] mb-3">
              Get Quote
            </h5>
            <p className="w-[300px] md:text-sm text-xs mb-5 lg:leading-7 lg:text-[25px] lg:w-[550px]">
