...
const HomeCarosal = () => {
  return (
    <div className='"w-full h-auto font-roboto text-white bg-black mx-auto flex flex-col justify-center items-center px-[24px] xl:px-[100px] gap-[25px] text-center'>
      <div className="flex flex-col text-center py-[25px] xl:py-[50px] gap-[25px]">
