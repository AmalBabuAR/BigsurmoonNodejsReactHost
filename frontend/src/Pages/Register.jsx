  ...
  return (
    <>
      ...
      >
        <div className="  transform  text-center">
          ...
          <div className=" flex flex-col justify-center h-full items-center  ">
            ...
            <label htmlFor="" className=" w-[320px] text-left mb-2">
              {" "}
              Name
            </label>
            <input
              type="text"
              className="w-[320px]  bg-transparent outline-none border-b border-gray-200"
              placeholder="Your Placeholder Text"
            />
            <label htmlFor="" className=" w-[320px] text-left mb-2 mt-8">
              {" "}
              Email
            </label>
            <input
            ...
            <input
              ...
              placeholder="Your Placeholder Text"
            />
            <div className="text-white text-sm flex items-center justify-center bg-gradient-to-r from-blue-500 to-blue-400 w-[125px] h-[30px]  rounded-full mt-7">
              <h3 className=" px-4 py-1  ">Sign up </h3>
            </div>
            <div className="flex  w-full justify-around items-center mt-10">
              <h2 className="w-20 h-[1px] bg-white"></h2>
              <h2 className=" "> Or sign up with</h2>
              <h2 className="w-20 h-[1px] bg-white"></h2>
            </div>
      ...
      <div
        ...
        style={{ backgroundImage: `url(${pcimg})` }}
      >
        <div className="xl:mt-12 xl:ml-10">
