...
function NewUI_AttributeObject(editor) {
	const strings = editor.strings;
	const signals = editor.signals;

	const container = new UIDiv();
	container.setId("attributeProperty");

	// position

	const objectPositionRow = new UIRow();
	const objectPositionIcon = document.createElement("img");
	objectPositionIcon.src = "images/translate.svg";
	objectPositionRow.dom.appendChild(objectPositionIcon);
	...
	const objectRotationIcon = document.createElement("img");
	objectRotationIcon.src = "images/rotate.svg";
	objectRotationRow.dom.appendChild(objectRotationIcon);
	...
	const objectScaleIcon = document.createElement("img");
	objectScaleIcon.src = "images/scale.svg";
	objectScaleRow.dom.appendChild(objectScaleIcon);
	...
	//BSM-dev added Animation
	const animation = new UISpan().add(new SidebarAnimation(editor));
