...
import { UINewTexture } from "./libs/ui.three.js";
...
function NewUI_SidebarMaterialMapProperty(editor, property, name) {
	...
	const map = new UINewTexture().onChange(onMapChange);
	map.setId("mapDiv");
	map.setSpan(name);
	container.add(map);
	...
	function onChange() {
		const newMap = map.getTrue() ? map.getValue() : null;
		console.log('*newMap ==',newMap);
		console.log('*enabled.getValue()',enabled.getValue());
		console.log('*map.getValue()',map.getValue());
...
export { NewUI_SidebarMaterialMapProperty };
