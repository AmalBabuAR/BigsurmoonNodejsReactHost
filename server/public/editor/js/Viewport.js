...
function Viewport( editor ) {
	...
	//BSM - Removing Camera and Shading dropdowns
	...
	const grid1 = new THREE.GridHelper( 20, 20, 0x888888 );
	grid1.material.color.setHex( 0x888888 );
	grid1.material.vertexColors = false;
	grid.add( grid1 );

	const grid2 = new THREE.GridHelper( 0, 0, 0x222222 );
	...
	//BSM - Checking if environment map is applied
	let needsApplyEnvironmentMap = true;
	...
	signals.sceneGraphChanged.add( function () {
		...
		// BSM - Added to apply a set environment map
		if(needsApplyEnvironmentMap){

		console.log("Setting Up Environment Map");
		const defaultEnvironment = new RoomEnvironment();
		const defaultEnvironmentTexture = pmremGenerator.fromScene(defaultEnvironment, 0.04).texture;
