...
import { LBautoRotationSvg } from "./LB_exportFunctions.js";
...
function createDesktopCollapse() {
	...
	autoRotateButton.innerHTML = LBautoRotationSvg;
	// this place
...
function callQrConfig() {
	...
	const urlToGenerateQRCodeFor = `https://bigsurmoon.com/custome/viewer/lethalBlack/?id=${idFromUrl}`;
...
function createMobileCollapse() {
	...
	mobAutoRotateButton.innerHTML = LBautoRotationSvg;
